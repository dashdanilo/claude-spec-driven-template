...
Mechanics of dispatching — parallelism, background, concurrency ceiling — live in `.claude/docs/harness/dispatching.md`. Who writes the code lives in `.claude/rules/harness/delegation.md`.
